...
function sizeCanvases() {
  ...
  if (inputImg.naturalWidth > inputImg.naturalHeight) {
    ...
    scaleHeight = 1600 * aspectRatio;

    console.log("Scaled to 1600 x " + scaleHeight);

    silkCanvas.height = scaleHeight;
    silkCanvas.style.top = (1600 / 2) - (scaleHeight / 2) + "px";
    maskCanvas.height = scaleHeight;
    maskCanvas.style.top = (1600 / 2) - (scaleHeight / 2) + "px";
    tStopCanvas.height = scaleHeight;
    copperCanvas.height = scaleHeight;
    copperCanvas.style.top = (1600 / 2) - (scaleHeight / 2) + "px";

    findDimensions(1600, scaleHeight);
    ...
    scaleWidth = 1600 * aspectRatio;

    console.log("Scaled to " + scaleWidth + " x 1600");

    silkCanvas.width = scaleWidth;
    silkCanvas.style.left = (1600 / 2) - (scaleWidth / 2) + "px";
    maskCanvas.width = scaleWidth;
    maskCanvas.style.left = (1600 / 2) - (scaleWidth / 2) + "px";
    tStopCanvas.width = scaleWidth;
    copperCanvas.width = scaleWidth;
    copperCanvas.style.left = (1600 / 2) - (scaleWidth / 2) + "px";

    findDimensions(scaleWidth, 1600);
