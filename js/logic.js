...
document.getElementById("drawLabelButton").onclick = drawLabel;
document.getElementById("invertCanvasButton").onclick = invertCanvas;
...
$("#downloadBrd").click(function() { 
   ...
   var blob = new Blob([brdFile], {type: "text/plain;charset=utf-8"});
